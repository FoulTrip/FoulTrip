...
const stackIcons = {
    ...
    "Nextjs": <SiNextdotjs size={30} className="text-black drop-shadow-md" />,
    ...
    "Vercel": <SiVercel size={30} className="text-black drop-shadow-md" />,
    "MongoDB": <SiMongodb size={30} className="text-green-600 drop-shadow-md" />,
    "Prisma": <SiPrisma size={30} className="text-black drop-shadow-md" />,
